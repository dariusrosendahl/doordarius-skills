...
| [`dutch-copy`](./plugins/doordarius-skills/skills/dutch-copy/SKILL.md) | Dutch copywriting and proofreading via Loes, with prompt-injection and semantic-drift gates before any copy reaches stdout |
